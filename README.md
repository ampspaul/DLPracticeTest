...
- **HomePage.js**: Landing page for test selection and initialization. Displays the main page heading **'TN Student Practice Test'**, styled with bold font weight (`font-weight: 700`), italic font style (`font-style: italic`), and Dark Red text colour (`#8B0000`). The heading style is applied consistently across all supported viewports (desktop ≥1024 px, tablet 768–1023 px, and mobile <768 px) to preserve responsive behaviour. No other text, layout, navigation, or functional behaviour is affected by this styling.
